...
import { deliveryStatusesList, FilterOrder, Order, orderAcceptanceStatusesList, OrderAction, OrderStatus, orderStatusesList, RefundStatus, refundStatusesList, clientServiceTypeList, pndDeliveryStatuesList, DeliveryStatus } from './model/order';
...
export class OrdersComponent implements OnInit, OnDestroy {
  ...
  deliveryStatusesList : { [key in DeliveryStatus]?: string } = deliveryStatusesList;
  ...
  ngOnInit(): void {
    ...
    if (this.service === Services.PND) {
      this.deliveryStatusesList = pndDeliveryStatuesList;
