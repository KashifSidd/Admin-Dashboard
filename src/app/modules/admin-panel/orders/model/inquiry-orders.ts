...
export class InquiryOrder {
  ...
  export class InquiryOrderDetails {
    ...
    static fromJson(data): InquiryOrderDetails {
      ...
      for (const m of data['menu_items']) {
        ...
        if (m['replacements']) {
          ...
          for (const r of m['replacements']) {
            menu['replacements'].push(Replacements.fromJson(r));
          }
        }
        menu['qty'] = m['quantity'];
      ...
      o['customerPhone'] = data['customer_phone'];
...
export class Replacements {
  ...
  static fromJson(data: any): Replacements {
    const r: Replacements = new Replacements();

    r['menuItemName'] = data['menu_item_name'];
    r['price'] = data['price'];
    r['maxQty'] = data['max_quantity'];
    r['displayPrice'] = data['display_price'];
