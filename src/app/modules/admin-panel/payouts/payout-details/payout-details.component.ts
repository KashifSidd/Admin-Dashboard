...
import { Services, pageSize, pageSizeOptions } from 'src/app/shared/models';
...
export class PayoutDetailsComponent implements OnInit {
  ...
  constructor(private payoutsService: PayoutsService, private router: Router, private ordersService: OrdersService, private outletsService: OutletsService) { }
  ngOnInit(): void {
