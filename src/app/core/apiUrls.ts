...
//API that update Rider order status & order delivery status
export const postAcceptRiderOrderEndPoint = (orderId: any, apiEndPoint: IApiEndPoint) => {
  return `${environment.baseUrl}/${apiEndPoint.service}/admin/order/accept/${orderId}`;
}

export const putRiderOrderLocationEndPoint = ( id: any, apiEndPoint: IApiEndPoint) => {
  return `${environment.baseUrl}/${apiEndPoint.service}/admin/order/location/status/${id}`;
}